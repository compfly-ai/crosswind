...
from agent_eval_core.evaluation.followup import detect_deflection_smart, generate_followup
...
from agent_eval_core.evaluation.recommendation_generator import RecommendationGenerator
...
from agent_eval_core.protocols import HTTPAgentError
from agent_eval_core.protocols.base import ProtocolAdapter
from agent_eval_core.storage.base import AnalyticsStorage, EvalDetail
...
class EvalRunner:
    ...
    async def _run_multiturn_prompts(
        ...
        from agent_eval_core.models import TurnEvaluatorInput
    ...
    def _doc_to_prompt(self, doc: dict[str, Any], dataset: dict[str, Any]) -> Prompt:
        ...
        from agent_eval_core.models import ConversationTurn, EvalType, ExpectedBehavior, JudgmentMode, Severity
